...
{opcode:'a6',blockType:rep0,text:'[a]>[b]',arguments:{a:{type:str0,defaultValue:'1'},b:{type:str0,defaultValue:'1'}}},
{opcode:'a7',blockType:rep0,text:'[a]==[b]',arguments:{a:{type:str0,defaultValue:'1'},b:{type:str0,defaultValue:'1'}}},
{opcode:'a8',blockType:rep0,text:'[a]>=[b]',arguments:{a:{type:str0,defaultValue:'1'},b:{type:str0,defaultValue:'1'}}},
{opcode:'a9',blockType:rep0,text:'[a]!=[b]',arguments:{a:{type:str0,defaultValue:'1'},b:{type:str0,defaultValue:'1'}}},
{opcode:'a19',blockType:rep0,text:'[a]??[b]',arguments:{a:{type:str0,defaultValue:''},b:{type:str0,defaultValue:'10'}}},
