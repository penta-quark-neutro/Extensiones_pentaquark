...
{opcode:'mp15',blockType:rep0,text:'[map].groupBy[a][b]',arguments:{a:{type:str0,defaultValue:'[...]'},b:{type:str0,defaultValue:'ƒ'},map:{type:str0,defaultValue:''}}},
{opcode:'mp16',blockType:com0,text:'[map].forEach[a]',arguments:{a:{type:str0,defaultValue:'ƒ'},map:{type:str0,defaultValue:''}}},
...
{opcode:'mp18',blockType:rep0,text:'¿[map]esMap?',arguments:{map:{type:str0,defaultValue:''}}},
...
{opcode:'mp17',blockType:bol0,text:'([a])=>[b]',arguments:{a:{type:txt,defaultValue:'a,b'},b:{type:txt,defaultValue:'a*b'}}},
],};}
...
mp15(ar){return ar.map.groupBy(ar.a,ar.b)}
mp16(ar){return ar.map.forEach(ar.a)}
mp17(ar){return Function('return ('+ar.a+')=>'+ar.b)()}
mp18(ar){return ar.a instanceof Map}
