...
{opcode:'E15',blockType:rep0,text:'generar firma HMAC hash[a]',arguments:{a:{type:str0,defaultValue:'SHA-512'}}},
...
{opcode:'E12',blockType:rep0,text:'verificar datos[a]llave[b]firma[c]',arguments:{a:{type:str0,defaultValue:'ArrayBuffer o TypedArray'},b:{type:str0,defaultValue:'llave HMAC'},c:{type:str0,defaultValue:'Firma'}}},
],};}
