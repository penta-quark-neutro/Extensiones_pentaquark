...
{blockType:"label",text:"Numeros complejos",hideFromPalette:complejos},
	...
	A:{type:vgd2,defaultValue:'2,10'},Bi:{type:vgd1,defaultValue:'2'}}},
	{opcode:'argz',blockType:vgbt,text:'Arg Z[A]',hideFromPalette:bloqueslentos||complejos,arguments:{
...
mulcuatco(ar){var vec1=Array.from(ar.q.split(','));var vec2=Array.from(ar.q2.split(','));
var dat0=((vec1[0]*vec2[0])-(vec1[1]*vec2[1])-(vec1[2]*vec2[2])-(vec1[3]*vec2[3]));
var dat1=((vec1[0]*vec2[1])+(vec1[1]*vec2[0])+(vec1[2]*vec2[3])-(vec1[3]*vec2[2]));
var dat2=((vec1[0]*vec2[2])-(vec1[1]*vec2[3])+(vec1[2]*vec2[0])+(vec1[3]*vec2[1]));
var dat3=((vec1[0]*vec2[3])+(vec1[1]*vec2[2])-(vec1[2]*vec2[1])+(vec1[3]*vec2[0]));
return dat0+','+dat1+','+dat2+','+dat3;}
...
divcuatco(ar){var vec1=Array.from(ar.q.split(','));var vec2=Array.from(ar.q2.split(','));
var modb=Math.pow(vec2[0],2)+(Math.pow(vec2[1],2))+(Math.pow(vec2[2],2))+(Math.pow(vec2[3],2));
var dat0=((vec1[0]*vec2[0])-(vec1[1]*-vec2[1])-(vec1[2]*-vec2[2])-(vec1[3]*-vec2[3]))/modb;
var dat1=((vec1[0]*-vec2[1])+(vec1[1]*vec2[0])+(vec1[2]*-vec2[3])-(vec1[3]*-vec2[2]))/modb;
var dat2=((vec1[0]*-vec2[2])-(vec1[1]*-vec2[3])+(vec1[2]*vec2[0])+(vec1[3]*-vec2[1]))/modb;
var dat3=((vec1[0]*-vec2[3])+(vec1[1]*-vec2[2])-(vec1[2]*-vec2[1])+(vec1[3]*vec2[0]))/modb;
return dat0+','+dat1+','+dat2+','+dat3;}
...
eelevcuatco(ar){var vec1=Array.from(ar.q.split(','));
var rad=Math.sqrt(Math.pow(vec1[1],2)+Math.pow(vec1[2],2)+Math.pow(vec1[3],2));
var senrad=Math.sin(rad)/rad;
var elev=Math.pow(euler,vec1[0]);
...
var modq=Math.sqrt(Math.pow(vec1[0],2)+Math.pow(vec1[1],2)+Math.pow(vec1[2],2)+Math.pow(vec1[3],2));
var modv=Math.sqrt(Math.pow(vec1[1],2)+Math.pow(vec1[2],2)+Math.pow(vec1[3],2));
var cdaq=Math.acos(vec1[0]/modq);
return (Math.log(modq)+','+(vec1[1]/modv*cdaq)+','+(vec1[2]/modv*cdaq)+','+(vec1[3]/modv*cdaq));}

vercuatco(ar){var vec1=Array.from(ar.a.split(','));
var mod=Math.sqrt(Math.pow(vec1[0],2)+Math.pow(vec1[1],2)+Math.pow(vec1[2],2)+Math.pow(vec1[3],2));
var dat0=vec1[0]/mod;
var dat1=vec1[1]/mod;
var dat2=vec1[2]/mod;
var dat3=vec1[3]/mod;
...
suoctonionrap(ar){var vec1=Array.from(ar.q.split(','));var vec2=Array.from(ar.w.split(','));
...
muloctonionrap(ar){var vec1=Array.from(ar.q.split(','));var vec2=Array.from(ar.w.split(','));
var dat0=(vec1[0]*vec2[0])-(vec1[1]*vec2[1])-(vec1[2]*vec2[2])-(vec1[3]*vec2[3])-(vec1[4]*vec2[4])-(vec1[5]*vec2[5])-(vec1[6]*vec2[6])-(vec1[7]*vec2[7]);
var dat1=(vec1[0]*vec2[1])+(vec1[1]*vec2[0])-(vec1[2]*vec2[3])+(vec1[3]*vec2[2])-(vec1[4]*vec2[5])+(vec1[5]*vec2[4])+(vec1[6]*vec2[7])-(vec1[7]*vec2[6]);
var dat2=(vec1[0]*vec2[2])+(vec1[1]*vec2[3])+(vec1[2]*vec2[0])-(vec1[3]*vec2[1])-(vec1[4]*vec2[6])-(vec1[5]*vec2[7])+(vec1[6]*vec2[4])+(vec1[7]*vec2[5]);
var dat3=(vec1[0]*vec2[3])-(vec1[1]*vec2[2])+(vec1[2]*vec2[1])+(vec1[3]*vec2[0])-(vec1[4]*vec2[7])+(vec1[5]*vec2[6])-(vec1[6]*vec2[5])+(vec1[7]*vec2[4]);
var dat4=(vec1[0]*vec2[4])+(vec1[1]*vec2[5])+(vec1[2]*vec2[6])+(vec1[3]*vec2[7])+(vec1[4]*vec2[0])-(vec1[5]*vec2[1])-(vec1[6]*vec2[2])-(vec1[7]*vec2[3]);
var dat5=(vec1[0]*vec2[5])-(vec1[1]*vec2[4])+(vec1[2]*vec2[7])-(vec1[3]*vec2[6])+(vec1[4]*vec2[1])+(vec1[5]*vec2[0])+(vec1[6]*vec2[3])-(vec1[7]*vec2[2]);
var dat6=(vec1[0]*vec2[6])-(vec1[1]*vec2[7])-(vec1[2]*vec2[4])+(vec1[3]*vec2[5])+(vec1[4]*vec2[2])-(vec1[5]*vec2[3])+(vec1[6]*vec2[0])+(vec1[7]*vec2[1]);
var dat7=(vec1[0]*vec2[7])+(vec1[1]*vec2[6])-(vec1[2]*vec2[5])-(vec1[3]*vec2[4])+(vec1[4]*vec2[3])+(vec1[5]*vec2[2])-(vec1[6]*vec2[1])+(vec1[7]*vec2[0]);
return dat0+','+dat1+','+dat2+','+dat3+','+dat4+','+dat5+','+dat6+','+dat7;}

divoctonionrap(ar){var vec1=Array.from(ar.q.split(','));var vec2=Array.from(ar.w.split(','));
var dat8=Math.pow(vec2[0],2)+Math.pow(vec2[1],2)+Math.pow(vec2[2],2)+Math.pow(vec2[3],2)+Math.pow(vec2[4],2)+Math.pow(vec2[5],2)+Math.pow(vec2[6],2)+Math.pow(vec2[7],2);
var dat0=((vec1[0]*vec2[0])-(vec1[1]*-vec2[1])-(vec1[2]*-vec2[2])-(vec1[3]*-vec2[3])-(vec1[4]*-vec2[4])-(vec1[5]*-vec2[5])-(vec1[6]*-vec2[6])-(vec1[7]*-vec2[7]))/dat8;
var dat1=((vec1[0]*-vec2[1])+(vec1[1]*vec2[0])-(vec1[2]*-vec2[3])+(vec1[3]*-vec2[2])-(vec1[4]*-vec2[5])+(vec1[5]*-vec2[4])+(vec1[6]*-vec2[7])-(vec1[7]*-vec2[6]))/dat8;
var dat2=((vec1[0]*-vec2[2])+(vec1[1]*-vec2[3])+(vec1[2]*vec2[0])-(vec1[3]*-vec2[1])-(vec1[4]*-vec2[6])-(vec1[5]*-vec2[7])+(vec1[6]*-vec2[4])+(vec1[7]*-vec2[5]))/dat8;
var dat3=((vec1[0]*-vec2[3])-(vec1[1]*-vec2[2])+(vec1[2]*-vec2[1])+(vec1[3]*vec2[0])-(vec1[4]*-vec2[7])+(vec1[5]*-vec2[6])-(vec1[6]*-vec2[5])+(vec1[7]*-vec2[4]))/dat8;
var dat4=((vec1[0]*-vec2[4])+(vec1[1]*-vec2[5])+(vec1[2]*-vec2[6])+(vec1[3]*-vec2[7])+(vec1[4]*vec2[0])-(vec1[5]*-vec2[1])-(vec1[6]*-vec2[2])-(vec1[7]*-vec2[3]))/dat8;
var dat5=((vec1[0]*-vec2[5])-(vec1[1]*-vec2[4])+(vec1[2]*-vec2[7])-(vec1[3]*-vec2[6])+(vec1[4]*-vec2[1])+(vec1[5]*vec2[0])+(vec1[6]*-vec2[3])-(vec1[7]*-vec2[2]))/dat8;
var dat6=((vec1[0]*-vec2[6])-(vec1[1]*-vec2[7])-(vec1[2]*-vec2[4])+(vec1[3]*-vec2[5])+(vec1[4]*-vec2[2])-(vec1[5]*-vec2[3])+(vec1[6]*vec2[0])+(vec1[7]*-vec2[1]))/dat8;
var dat7=((vec1[0]*-vec2[7])+(vec1[1]*-vec2[6])-(vec1[2]*-vec2[5])-(vec1[3]*-vec2[4])+(vec1[4]*-vec2[3])+(vec1[5]*-vec2[2])-(vec1[6]*-vec2[1])+(vec1[7]*vec2[0]))/dat8;
return dat0+','+dat1+','+dat2+','+dat3+','+dat4+','+dat5+','+dat6+','+dat7;}
...
var Z1=unosobrez(ar.A*10,ar.BI*10);
var Z2=((ar.A*12)-(Z1.split(',')[0]*1))+','+((ar.BI*12)-(Z1.split(',')[1]*1));
var Z3=unosobrez((Z2.split(',')[0]*1),(Z2.split(',')[1]*1));
var Z4=((ar.A+(Z3.split(',')[0]*1))*(1/euler))+','+((ar.BI+(Z3.split(',')[1]*1))*(1/euler));
var reg2=Z4.split(',')[0];
var img2=Z4.split(',')[1];
var modz=Math.sqrt((reg2*reg2)+(img2*img2));
var argz=Math.atan2(img2,reg2);
var Z5=Math.log(modz)+','+argz;
var reg3=((ar.A*Z5.split(',')[0])-(ar.BI*Z5.split(',')[1]));
var img3=((ar.A*Z5.split(',')[1])+(Z5.split(',')[0]*ar.BI));
var ARC=unosobrez(ar.A,ar.BI);
var reg1=(ARC.split(',')[0]*2*3.14159265358979);
var img1=(ARC.split(',')[1]*2*3.14159265358979);
var dat0=Math.sqrt((reg1*reg1)+(img1*img1));
var dat1=Math.atan2(img1,reg1);
var dat2=Math.pow(dat0,1/2);
var pa3=Math.pow(euler,reg3);
var Z6=(Math.cos(img3)*pa3)+','+(Math.sin(img3)*pa3);
var Z7=(Math.cos(((dat1+(0/180))/2)))*dat2+','+(Math.sin(((dat1+(0/180))/2)))*dat2;
